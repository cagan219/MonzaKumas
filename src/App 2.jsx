          ...
          <div className="fixed top-0 left-0 h-full w-80 bg-white shadow-xl z-50">
            <div className="p-6">
              ...
              <nav className="space-y-4">
                <a href="/products" className="block px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg">All Products</a>
                <a href="/catalog" className="block px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg">Catalog</a>
                <a href="/about" className="block px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg">About Us</a>
                <a href="/contact" className="block px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg">Contact</a>
              </nav>
            </div>
          </div>
        </>
